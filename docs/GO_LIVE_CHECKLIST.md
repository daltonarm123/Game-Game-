...
- [x] Initial API transient-DB integration harness added (`scripts/run-api-integration-with-transient-db.sh`) with shield cooldown, marketplace, alliances, and settlements integration coverage.
- [x] Add API integration tests against a transient Postgres instance for initial war scenarios.
